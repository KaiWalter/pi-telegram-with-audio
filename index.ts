 ...
 * pi-telegram-sandbox
 *
 * VENDORED FORK of git:github.com/llblab/pi-telegram @ 8418c059f4277a6c0b59fab190a08dc50b2cbea5
 * (0.13.2 lineage incl. 0.13.1 reliability + 0.13.2 config/inbound bounds hotfixes).
 * See SNAPSHOT.md for provenance.
 *
...
export default function (pi: Pi.ExtensionAPI) {
  ...
  // New-session bridge: /new reset interception.
  try {
